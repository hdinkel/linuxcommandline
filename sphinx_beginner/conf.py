# -*- coding: utf-8 -*-
#
# Introduction to the Linux Commandline documentation build configuration file, created by sphinx-quickstart on Tue May 28 02:17:37 2013.
#
...
html_title = u'Introduction to the Linux Commandline'

# A shorter title for the navigation bar.  Default is the same as html_title.
#html_short_title = u'Linux Introduction'
...
htmlhelp_basename = 'IntroductiontotheLinuxCommandlinedoc'
...
latex_documents = [
  ('index', 'IntroductiontotheLinuxCommandline.tex', u'Introduction to the Linux Commandline Documentation',
   u'Holger Dinkel, Frank Thommen \\& Thomas Zichner', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = '_static/bio-it_logo.png'
...
man_pages = [
    ('index', 'introductiontothelinuxcommandline', u'Introduction to the Linux Commandline Documentation',
